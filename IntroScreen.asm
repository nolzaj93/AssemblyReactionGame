...
start:		
				...
				JMP			cont1
PushBtnMsg:			.db			"PUSH MY BUTTON TO SEE",0
cont1:				LDI			ZL,low(PushBtnMsg << 1)
				LDI			ZH,high(PushBtnMsg << 1)
				CALL			LCDPrintf

				//TOP LEFT BUTTON: START (Row 2)
				LDI			R16,0					; colm. Set the row and colm to 0 each
				MOV			R0,R16
				LDI			R16,3					; row
				MOV			R1,R16
				...
				JMP			cont2
StartMsg:				.db			"TOP LEFT BTN: START",0
cont2:				LDI			ZL,low(StartMsg << 1)
				LDI			ZH,high(StartMsg << 1)
				CALL			LCDPrintf
...
LCDData27:		.DB			0x00,0x00,0x06,0x00,0x00,0x00 ; '
...
LCDData3A:		.DB			0x00,0x00,0x42,0x42,0x00,0x00 ; :
...
LCDData3F:		.DB			0x00,0x0C,0x93,0x93,0x06,0x00 ; ?			
